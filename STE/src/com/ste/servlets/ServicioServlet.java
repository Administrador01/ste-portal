...
public class ServicioServlet  extends HttpServlet{
		...
		String accion = req.getParameter("accion");
		 ...
		 try {
			...
			String usermail = (String) sesion.getAttribute("mail");
				...
				if (accion.equals("rest"))createElse(req,resp,usermail);
	...
	public void createElse(HttpServletRequest req, HttpServletResponse resp, String usermail) throws InterruptedException{
		...
		prod.setNme(nombreProducto);
		prod.setImplementaciones(true);
		prod.setSoportes(true);
		prod.setPruebas(true);
		prodDao.createProductoCanal(prod);
		
		prod = new ProductoCanal();
		nombreProducto = "Swift Fileact (antigua conecxión)";
		prod.setNme(nombreProducto);
		prod.setImplementaciones(true);
		prod.setSoportes(true);
		prod.setPruebas(true);
		...
		prodDao.createProductoCanal(prod);
		prod = new ProductoCanal();
		nombreProducto = "Cashpool doméstico";
		prod.setNme(nombreProducto);
		prod.setImplementaciones(false);
		prod.setSoportes(true);
		prod.setPruebas(true);
		prodDao.createProductoCanal(prod);
		prod = new ProductoCanal();
