...
public class ClienteServlet extends HttpServlet {
	...
	public void deleteClient(HttpServletRequest req, HttpServletResponse resp,
			String usermail) throws JSONException, IOException {
	...
	public void restoreClient(HttpServletRequest req, HttpServletResponse resp,
			String usermail) throws JSONException, IOException {
	...
	public void updateClient(HttpServletRequest req, HttpServletResponse resp,
		...
		// recuperamos las pruebas relacionadas conel cliente para cambiar el
		// nombre de cliente de ellas
	...
	public void createClient(HttpServletRequest req, HttpServletResponse resp,
			String usermail) throws JSONException, IOException {
		JSONObject json = new JSONObject();
		ClienteDao cDao = ClienteDao.getInstance();
